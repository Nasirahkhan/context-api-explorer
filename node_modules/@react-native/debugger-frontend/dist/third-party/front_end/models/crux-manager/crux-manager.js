...
const a={fieldOverrideWarning:"Field data is configured for a different URL than the current page."},
  o=t.i18n.registerUIStrings("models/crux-manager/CrUXManager.ts",a),
  s=t.i18n.getLocalizedString.bind(void 0,o);
let 
  c;const l=["ALL","DESKTOP","PHONE"],
  g=["origin","url"],
  d=["first_contentful_paint",
...
class u extends e.ObjectWrapper.ObjectWrapper{#e=new Map;
                                              #t=new Map;
                                              #i;
                                              #r;
                                              // #n="https://chromeuxreport.googleapis.com/v1/records:queryRecord?key=AIzaSyCCSOx25vrb5z0tbedCB3_JRzzbVW6Uwgw";
                                              #a;
                                              fieldDeviceOption="AUTO";
                                              fieldPageScope="url";constructor(){super();
                                                                                 ...
                                                                                 this.#r=e.Settings.Settings.instance().createSetting("field-data",
                                                                                   ...
                                                                                   r.TargetManager.TargetManager.instance().addModelListener(r.ResourceTreeModel.ResourceTreeModel,
                                              ...
                                              get pageResult()
                                              {return this.#a}getConfigSetting()
                                              {return this.#r}isEnabled()
                                              {return this.#r.get().enabled}
                                              async getFieldDataForPage(e)
                                              {const t={"origin-ALL":null,
                                                        "origin-DESKTOP":null,
                                                        "origin-PHONE":null,
                                                        "origin-TABLET":null,
                                                        "url-ALL":null,
